...
import '../styles/OrdenCompraCreate.css';

const OrdenCompraCreateCliente = () => {
  ...
  const { productos, ultimaOrdenCompra } = location.state || { productos: [], ultimaOrdenCompra: '' };

  const [formData, setFormData] = useState({
    amount: 0,
    clientName: clientName,
    quantity: 0,
    number: ultimaOrdenCompra,
  ...
  useEffect(() => {
    ...
    console.log("Valores de productos al cargar la página:", productos);
  }, []);
  ...
  const handleSubmit = async () => {
    ...
    const purchaseOrder = {
      ...
      messageState: formData.messageState,
    ...
    try {
      const response = await fetch('https://api.maderasdelatlantico.com/api/PurchaseOrder/crearpurchaseorder', {
        method: 'POST',
        headers: {
      ...
      console.log('Orden de compra creada:', result);

      Swal.fire({
        icon: 'success',
        title: 'Orden creada',
        text: 'La orden de compra se creó exitosamente',
        timer: 2000,
      ...
      Swal.fire({
        icon: 'error',
        title: 'Error',
        text: 'Hubo un problema al crear la orden de compra',
  ...
  return (
    <div className="orden-compra-crear-container">
      ...
      <div className="orden-compra-crear-header">
        ...
        <h1 className="orden-compra-crear-title">Crear Orden de Compra</h1>
      </div>
      <form>
        <div className="orden-compra-crear-form-group">
          ...
          <div className="orden-compra-crear-form-row">
            <div className="orden-compra-crear-form-col">
              <label>Cliente</label>
              <input type="text" value={formData.clientName} readOnly className="orden-compra-crear-input" />
            </div>
            <div className="orden-compra-crear-form-col">
          ...
          <div className="orden-compra-crear-form-row">
            <div className="orden-compra-crear-form-col">
              ...
              <input type="text" value='Julio César Pérez' readOnly className="orden-compra-crear-input" />
            </div>
            <div className="orden-compra-crear-form-col">
              <label>Semana</label>
              <input
...
export default OrdenCompraCreateCliente;
