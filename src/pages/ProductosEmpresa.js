...
const ProductosEmpresa = () => {
  ...
  const obtenerProductos = async () => {
    try {
      const response = await fetch(`http://localhost:6001/api/Product/obtenerproductosgeneral?companyId=${empresa.companyId}`);
  ...
  const handleSaveProduct = async () => {
    try {
      const response = await fetch('http://localhost:6001/api/Product/editarproducto', {
        method: 'POST',
        headers: {
  ...
  const handleDeleteProduct = async () => {
    try {
      const response = await fetch(`http://localhost:6001/api/Product/eliminarproducto?productId=${editProduct.productId}&companyId=${empresa.companyId}`, {
        method: 'DELETE',
      });
  ...
  const handleAddProduct = async () => {
    try {
      const response = await fetch('http://localhost:6001/api/Product/crearproducto', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
